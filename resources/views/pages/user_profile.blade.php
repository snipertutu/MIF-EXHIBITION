            ...
            <div class="card card-small mb-4 pt-3">
                <div class="card-header border-bottom text-center">
                    <div class="mb-3 mx-auto">
                        <img class="user-avatar rounded-circle mr-2" src="{{ url($user->detailUser->foto) }}"
                            alt="User Avatar" width="150" height="150">
                    </div>
                    <h4 class="mb-0">{{ $user->nama }}</h4>
                    @if ($user->status == 1)
                    <span
                        class="text-muted d-block mb-2">{{ $user->detailUser->divisi->nama." ● ".$user->detailUser->jabatan->nama }}</span>
                    @endif
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <form>
                                    ...
                                    @if (!empty($user->detailUser->bukti_mahasiswa) ||
                                    !empty($user->detailUser->bukti_kesanggupan))
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                                ...
                                                <table class="ff_fileupload_uploads">
                                                    <tr class="">
                                                        <td class="ff_fileupload_preview">
                                                            <button
                                                                class="ff_fileupload_preview_image ff_fileupload_preview_text_with_color ff_fileupload_preview_text_d"
                                                                type="button" disabled=""
                                                                aria-label="No preview available">File</button>
                                                        </td>
                                                        <td class="ff_fileupload_summary">
                                                            <div class="ff_fileupload_filename w-100"
                                                                id="buktiMahasiswaNama">
                                                                Bukti Kesanggupan
                                                            </div>
                                                            <div class="ff_fileupload_fileinfo" id="buktiMahasiswaInfo">
                                                                <a
                                                                    href="{{ url($user->detailUser->bukti_kesanggupan) }}">Lihat
                                                                    File</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ...
                                                <table class="ff_fileupload_uploads">
                                                    <tr class="">
                                                        ...
                                                        <td class="ff_fileupload_summary">
                                                            ...
                                                            <div class="ff_fileupload_fileinfo" id="buktiMahasiswaInfo">
                                                                <a href="{{ url($user->detailUser->bukti_mahasiswa) }}">Lihat
                                                                    File</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                    ...
                                    @endif
                                    <button type="submit" class="btn btn-accent btn-update-profile">Update
                                        Profile</button>
                                </form>
                            </div>
                        </div>
